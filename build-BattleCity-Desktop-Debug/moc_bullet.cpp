...
QT_MOC_LITERAL(1, 7, 13), // "signalDestroy"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 14), // "signalGameOver"
QT_MOC_LITERAL(4, 37, 13), // "signalKillBot"
QT_MOC_LITERAL(5, 51, 15) // "slotTimerBullet"

    },
    "Bullet\0signalDestroy\0\0signalGameOver\0"
    "signalKillBot\0slotTimerBullet"
};
...
void Bullet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->signalKillBot(); break;
        case 3: _t->slotTimerBullet(); break;
        default: ;
        }
        ...
        {
            typedef void (Bullet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bullet::signalDestroy)) {
                *result = 0;
            }
        }
        {
            typedef void (Bullet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bullet::signalGameOver)) {
                *result = 1;
            }
        }
        {
            typedef void (Bullet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Bullet::signalKillBot)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void Bullet::signalDestroy()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void Bullet::signalGameOver()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void Bullet::signalKillBot()
{
