...
const QString PATH_TO_BONUS_TIME      = ":/walls/gnanade.jpg";
...
const int CNT_SECOND_SHOW_STAR          = 10000;
const int CNT_SECOND_PROTECTION_BASE    = 20000;
const int CNT_SECOND_STOP_ALL_BOT       = 40000;
...
const int CNT_BEGIN_X_THREE_BOT = 350;
const int CNT_BEGIN_Y_THREE_BOT = 0;
const int CNT_BEGIN_X_FOUR_BOT  = 50;
...
const int CNT_TIME_APPEARANCE_TWO_BOT   = 10000;
const int CNT_TIME_APPEARANCE_THREE_BOT = 20000;
const int CNT_TIME_APPEARANCE_FOUR_BOT  = 30000;
